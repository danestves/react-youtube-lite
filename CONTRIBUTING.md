# Contributing to react-youtube-lite

First and foremost, thank you! We appreciate that you want to contribute to react-youtube-lite, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for react-youtube-lite**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for react-youtube-lite:

- star the [project](https://github.com/Daniel%20Esteves/react-youtube-lite)
- tweet your support for react-youtube-lite
...
- **version**: (required) please note the version of react-youtube-lite are you using
...
The original poster or the maintainers of react-youtube-lite may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/react-youtube-lite
